...
{
    [TestClass]
    public class CenterRowWinTests
    {
        ...
        public void IsWin_ShouldReturnTrueForWin()
        {
            ...
            CenterRowWin subject = new CenterRowWin(cellCollection);
        ...
        public void IsWin_ShouldReturnFalseForNotWin()
        {
            ...
            ICell[] cells = {
                new UnselectedCell(new Glyph('0')), new UnselectedCell(new Glyph('1')), new UnselectedCell(new Glyph('2')),
                new UnselectedCell(new Glyph('?')), new UnselectedCell(new Glyph('?')), new UnselectedCell(new Glyph('5')),
                new UnselectedCell(new Glyph('6')), new UnselectedCell(new Glyph('7')), new UnselectedCell(new Glyph('8'))
