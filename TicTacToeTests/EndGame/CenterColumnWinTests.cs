...
{
    [TestClass]
    public class CenterColumnWinTests
    {
        ...
        public void IsWin_ShouldReturnTrueForWin()
        {
            //Arrange
            ICell[] cells = {
                new UnselectedCell(new Glyph('0')), new UnselectedCell(new Glyph('?')), new UnselectedCell(new Glyph('2')),
                new UnselectedCell(new Glyph('3')), new UnselectedCell(new Glyph('?')), new UnselectedCell(new Glyph('5')),
                new UnselectedCell(new Glyph('6')), new UnselectedCell(new Glyph('?')), new UnselectedCell(new Glyph('8'))

            };
            CellCollection cellCollection = new CellCollection(cells);
            CenterColumnWin subject = new CenterColumnWin(cellCollection);
